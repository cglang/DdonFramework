...
<template>
  <div style="height: 100vh; display: flex; flex-direction: column; overflow: hidden">
    ...
    <el-row align="middle" style="padding: 0 20px; height: 60px; border-bottom: 1px solid var(--el-border-color-light); background: #fff; flex-shrink: 0">
      <el-button text @click="router.push('/main')" style="font-size: 20px; font-weight: 600; color: #303133">
        上位机平台
      </el-button>
      <span v-if="route.meta.location" style="font-size: 14px; color: #909399; margin-left: 12px">
        位置：{{ route.meta.location }}
      </span>
