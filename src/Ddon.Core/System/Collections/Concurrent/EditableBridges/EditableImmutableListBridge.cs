...
namespace System.Collections.Concurrent.EditableBridges
{
    /// <summary>
    ...
    internal class EditableImmutableListBridge<T> : IList<T>, IList // Have to implement IList to get the new row in WPF DataGrid
    {
        ...
        public void Add(T item) => Sync(() => _destination.Add(item));
        ...
        public void Insert(int index, T item) => Sync(() => _destination.Insert(index, item));

        public bool Remove(T item) => Sync(() => _destination.Remove(item));
        ...
        int IList.Add(object? value) => Sync(() => _destination.Add(value));
        ...
        void IList.Insert(int index, object? value) => Sync(() => _destination.Insert(index, value));

        void IList.Remove(object? value) => Sync(() => _destination.Remove(value));
